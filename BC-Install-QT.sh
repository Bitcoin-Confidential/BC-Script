...
TEMP_PATH=/tmp/bitcoinc-1.0.0.0
USER_FOLDER_NAME=Bitcoin-Confidential
DESKTOP_FILENAME=bitcoin-confidential.desktop
ICON_FILENAME=bitcoinc.png
WALLET_URL="https://github.com/Bitcoin-Confidential/BitcoinC-Core/releases/download/v1.0.0/bitcoinc-1.0.0.0-x86_64-linux-gnu.tar.gz"
