...
wget "https://github.com/Bitcoin-Confidential/BitcoinC-Core/releases/download/v1.0.1/bitcoinc-1.0.1-x86_64-linux-gnu.tar.gz" -O - | tar -xz

# Extract the files and give executable permissions
echo 'Copying files to home directory'
cp bitcoinc-1.0.1/bin/bitcoincd ~/ 
cp bitcoinc-1.0.1/bin/bitcoinc-cli ~/
...
#ln -sf ~/bitcoinc-1.0.1/bin/bitcoincd /usr/bin/bitcoincd
#ln -sf ~/bitcoinc-1.0.1/bin/bitcoinc-cli /usr/bin/bitcoinc-cli
